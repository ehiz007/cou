					...
					<div className='formBx'>
							...
							<form action="">
                                ...
                                <div className="inputBx mt-3">
                                    <label htmlFor="cat"> <b>Select</b> </label>
                                    <select name="cat" id="cat">
                                        <option value="Xienna">Xienna</option>
                                        <option value="Couriax">Couriax</option>
                                        <option value="EUtra">EUtra</option>
								...
								<div className="inputBx mt-3">
									...
									<input type="text" placeholder=" Enter your subcategory name" name="catname" required></input>
								</div>
